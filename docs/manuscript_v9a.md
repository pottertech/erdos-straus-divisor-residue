...
*Outside these subcases, the implication is not valid in general. In the tested range, 821 cases have −1 ∈ H(A) but −1 ∉ D_A((nx)²). Nevertheless, the target T may still lie in D_A through alternative divisor paths (see §3.6 and analysis/item1_lemma/centered_residue_analysis.json).*
